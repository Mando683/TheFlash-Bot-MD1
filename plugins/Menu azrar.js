...
> ˼🤖˹↜ الــبــوت↶
╮───────────────────⟢ـ
┆⚙️ ↜اسـم الـبـوت↶﹝𝐵𝛩𝑇 𝑀𝐴𝑁𝐷𝛩﹞
┆🪄 ↜الـمـطـور ↶﹝𝑀𝐴𝑁𝐷𝛩﹞
┆📌 ↜الـتـشـغـيـل ↶﹝${uptime}﹞
┆🔖 ↜الــمــســتـخـدمـيـن ↶﹝${rtotalreg}﹞
╯───────────────────⟢ـ
> © 𝐵𝛩𝑇 & 𝑀𝐴𝑁𝐷𝛩 2025`,subtitle: "Araab Zack",},header: { hasMediaAttachment: true,...(await prepareWAMessageMedia({ image : { url: zack } }, { upload: conn.waUploadToServer }, {quoted: m}))},
                    contextInfo: {
                                    ...
                                    sections: [
                                        {
                                            ...
                                            highlight_label: 'منور اقسام بوت ماندو يعمري',
                                            rows: [
                                                {
                  ...
                  messageParamsJson: ''
                     ...
                     {
               name: "cta_url",
               buttonParamsJson: '{"display_text":"⌈📲╎قـنـاة الــبــوت╎📲⌋","url":"https://whatsapp.com/channel/0029VarJdJO7dmeZS5ZKft1U","merchant_url":"https://whatsapp.com/channel/0029VaoUBmSKmCPIIiEatx1H"}'
                            }
                        ]
                    }
                }
